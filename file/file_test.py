...
# open( "파일명 ","모드") 모드 - r: 읽기 , w :쓰기(덮었쓰기) , a: 추가
...
#문제 1 input 함수로 임력받은 값을 note.txt에 저장하시오
...
파일이름 = email.split("@")[0]+".txt"

with open("file/파일이름", "w", encoding="utf-8") as f:
    f.write(name+"\n")
    f.write(email+"\n")
    f.write(password+"\n")
    f.write(age+"\n")